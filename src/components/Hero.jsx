    ...
    >
      <div className="grid md:grid-cols-2 max-w-[1240px] m-auto">
        <div className="flex flex-col justify-center md:items-start w-full px-2 py-8">
          <p className="text-2xl xs:text-xl">Unique Sequencing & Production</p>
          <h1 className="py-3 text-5xl md:text-7xl xs:text-5xl font-bold">
            Cloud Management
          </h1>
          <p className="text-2xl xs:text-xl">This is our Tech Brand.</p>
          <button className={`my-4 py-3 px-9 sm:w-[60%] xs:w-[60%] bg-indigo-600 border-indigo-600 `}>
            Get Started
          </button>
        </div>
        <div>
